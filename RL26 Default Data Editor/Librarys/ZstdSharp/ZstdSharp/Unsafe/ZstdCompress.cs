...
namespace ZstdSharp.Unsafe
{
    public static unsafe partial class Methods
    {
        ...
        {
            /*content*/
            ZSTD_frameParameters fParams = new()
            {
                contentSizeFlag = 1,
                checksumFlag = 0,
                noDictIDFlag = 0
...

            {
                ...
                else if (ZSTD_hasExtSeqProd(&zc->appliedParams) != 0)
                {
                    ...
                    assert(zc->appliedParams.extSeqProdFunc != null);
                    {
                        ...
                        {
                            ZSTD_SequencePosition seqPos = new()
                            {
                                idx = 0,
                                posInSequence = 0,
                                posInSrc = 0
        ...
        {
            ZSTD_symbolEncodingTypeStats_t stats = new()
            {
